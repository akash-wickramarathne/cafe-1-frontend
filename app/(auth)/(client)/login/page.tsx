...
const Login = () => {
  ...
  //   const { email, password } = data; // Destructure email and password from the data object
  ...
  const submitForm = async (data: z.infer<typeof LoginSchema>) => {
    const { email, password } = data; // Destructure email and password from the data object
    const shouldRemember = true; // Define the remember me option if it's not part of the form
      ...
      <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    {...field}
                                    disabled={isPending}
                                    placeholder="akash.does@emaple.com"
                                    type="email"
                                  />
                                </FormControl>
                                <FormMessage />
          ...
          <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
            <div
              className="w-full bg-red-400  bg-cover "
              style={{
                backgroundImage: "url('/auth-resources/coffe3.jpg')",
              }}
            ></div>
          </div>
        </div>
